...
export const selectAlertInfo = createSelector(
  selectLayoutState,
  fromLayout.selectAlertInfo
);
export const selectUsername = createSelector(
  selectLayoutState,
  fromLayout.selectUsername
);
export const selectMuteState = createSelector(
  selectLayoutState,
  fromLayout.selectIsMute
);
...
export const selectRouteNestedParam = () => createSelector(selectRouteNestedParams, (params) => params);
